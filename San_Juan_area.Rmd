...
```{r 389 sd summer mk & ss non corrected}
...
```{r 389 sd winter mk & ss non corrected}
...
```{r 389 summer sd mk & ss adjusted}
...
```{r 389 winter sd mk & ss adjusted}
...
#### Spring
```{r 389 SD spring NOT CORRECTED}
spring_standard_dev_all_389 <- standard_dev_389 %>%
  filter(waterDay >= 183 & waterDay <= 243) %>%
  group_by(waterYear) %>% 
  mutate(nmbr = n())

spring_standard_dev_all_389 <- spring_standard_dev_all_389 %>% 
  group_by(waterYear) %>% 
  mutate(resid_mean = mean(residual)) %>%
  mutate(sd_1 = residual-resid_mean) %>% 
  mutate(sd_2 = (((sum((sd_1)^2))/((nmbr-1))))^(0.5)) %>%
...
spring_standard_dev_all_389 %>% 
  kable(.,'html') %>%
  kable_styling() %>%
  scroll_box(width='250px',height='500px')

ggplot(spring_standard_dev_all_389, aes(x = waterYear, y = sd_2))+
  geom_line(size= 0.7) +
  theme_few() +
  geom_smooth(method = "lm", se=FALSE) +
  ylab('SD') + 
...
*Non-corrected standard deviation of SNOTEL 389 average spring temperatures for water years 2005-2021* 


#### spring MK & SS for 389 (non-corrected)

```{r 389 sd spring mk & ss non corrected}

spring_sd_mk_389 <- mk.test(spring_standard_dev_all_389$sd_2)
print(spring_sd_mk_389)

spring_sd_sens_389 <- sens.slope(spring_standard_dev_all_389$sd_2)
print(spring_sd_sens_389)
...
```{r 389 SD fall NOT CORRECTED}
fall_standard_dev_all_389 <- standard_dev_389 %>%
  filter(waterDay >= 336 | waterDay <= 31) %>% 
  group_by(waterYear) %>% 
  mutate(nmbr = n())

fall_standard_dev_all_389 <- fall_standard_dev_all_389 %>% 
  #group_by(waterYear) %>% 
  mutate(resid_mean = mean(residual)) %>%
  mutate(sd_1 = residual-resid_mean) %>% 
  mutate(sd_2 = (((sum((sd_1)^2))/((nmbr-1))))^(0.5)) %>%
...
fall_standard_dev_all_389 %>% 
  kable(.,'html') %>%
  kable_styling() %>%
  scroll_box(width='250px',height='500px')

ggplot(fall_standard_dev_all_389, aes(x = waterYear, y = sd_2))+
  geom_line(size= 0.7) +
  theme_few() +
  geom_smooth(method = "lm", se=FALSE) +
  ylab('SD') + 
...
*Non-corrected standard deviation of SNOTEL 389 average fall temperatures for water years 2005-2021. Note that the season is split by the water year.* 


#### fall MK & SS for 389 (non-corrected)

```{r 389 sd fall mk & ss non corrected}

fall_sd_mk_389 <- mk.test(fall_standard_dev_all_389$sd_2)
print(fall_sd_mk_389)

fall_sd_sens_389 <- sens.slope(fall_standard_dev_all_389$sd_2)
print(fall_sd_sens_389)
...
Spring
```{r 389 SD Spring}
spring_standard_dev_all_389_ad <- standard_dev_389_ad %>% 
  filter(waterDay >= 183 & waterDay <= 243) %>%
  group_by(waterYear) %>% 
  mutate(nmbr = n())
spring_standard_dev_all_389_ad <- spring_standard_dev_all_389_ad %>% 
  group_by(waterYear) %>% 
  mutate(resid_mean = mean(residual)) %>%
  mutate(sd_1 = residual-resid_mean) %>% 
  mutate(sd_2 = (((sum((sd_1)^2))/((nmbr-1))))^(0.5)) %>%
  distinct(sd_2, .keep_all = TRUE) %>% 
   select(waterYear, sd_2)
spring_standard_dev_all_389_ad %>% 
  kable(.,'html') %>%
  kable_styling() %>%
  scroll_box(width='250px',height='500px')
ggplot(spring_standard_dev_all_389_ad, aes(x = waterYear, y = sd_2))+
  geom_line(size= 0.7) +
  theme_few() +
  geom_smooth(method = "lm", se=FALSE) +
  ylab('SD') + 
...
*Morrisey-corrected standard deviation of SNOTEL 389 average spring temperatures for water years 1986-2021* 

#### spring MK & SS 389 (corrected)

```{r 389 spring sd mk & ss adjusted}
spring_sd_mk_389_ad <- mk.test(spring_standard_dev_all_389_ad$sd_2)
print(spring_sd_mk_389_ad)

spring_sd_sens_389_ad <- sens.slope(spring_standard_dev_all_389_ad$sd_2)
print(spring_sd_sens_389_ad)

```

Fall
```{r 389 SD fall}
fall_standard_dev_all_389_ad <- standard_dev_389_ad %>% 
  filter(waterDay >= 336 | waterDay <= 31) %>%
  group_by(waterYear) %>% 
  mutate(nmbr = n())
fall_standard_dev_all_389_ad <- fall_standard_dev_all_389_ad %>% 
  group_by(waterYear) %>% 
  mutate(resid_mean = mean(residual)) %>%
  mutate(sd_1 = residual-resid_mean) %>% 
  mutate(sd_2 = (((sum((sd_1)^2))/((nmbr-1))))^(0.5)) %>%
  distinct(sd_2, .keep_all = TRUE) %>% 
   select(waterYear, sd_2)
fall_standard_dev_all_389_ad %>% 
  kable(.,'html') %>%
  kable_styling() %>%
  scroll_box(width='250px',height='500px')
ggplot(fall_standard_dev_all_389_ad, aes(x = waterYear, y = sd_2))+
  geom_line(size= 0.7) +
  theme_few() +
  geom_smooth(method = "lm", se=FALSE) +
  ylab('SD') + 
...
*Morrisey-corrected standard deviation of SNOTEL 389 average fall temperatures for water years 1986-2021. Note that the fall season is split by the water year.* 

#### fall MK & SS 389 (corrected)

```{r 389 fall sd mk & ss adjusted}
fall_sd_mk_389_ad <- mk.test(fall_standard_dev_all_389_ad$sd_2)
print(fall_sd_mk_389_ad)

fall_sd_sens_389_ad <- sens.slope(fall_standard_dev_all_389_ad$sd_2)
print(fall_sd_sens_389_ad)
