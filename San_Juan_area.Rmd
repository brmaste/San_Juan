...
```{r 387 sd mk & ss non corrected, eval=FALSE}
...
```{r 387 sd mk & ss adjusted, eval=FALSE}
...
(Errors~!)
```{r 387 sd summer mk & ss non corrected, eval=FALSE}
...
z = -3.1018, n = 28, p-value = 0.001924
alternative hypothesis: true S is not equal to 0
sample estimates:
           S         varS          tau 
-158.0000000 2562.0000000   -0.4179894 
...
```{r 387 sd winter mk & ss non corrected, eval=FALSE}
...
sample estimates:
            S          varS           tau 
 -16.00000000 2562.00000000   -0.04232804 
...
```{r 387 summer sd mk & ss adjusted, eval=FALSE}
...
```{r 387 winter sd mk & ss adjusted, eval=FALSE}
...
sample estimates:
           S         varS          tau 
2.800000e+01 2.562000e+03 7.407407e-02 
...
```{r 387 sd spring mk & ss non corrected, eval=FALSE}
...
```{r 387 sd fall mk & ss non corrected, eval=FALSE}
...
z = -0.88904, n = 28, p-value = 0.374
alternative hypothesis: true S is not equal to 0
sample estimates:
           S         varS          tau 
 -46.0000000 2562.0000000   -0.1216931 
...
```{r 387 spring sd mk & ss adjusted, eval=FALSE}
...
```{r 387 fall sd mk & ss adjusted, eval=FALSE}
...
z = 0.019757, n = 28, p-value = 0.9842
alternative hypothesis: true S is not equal to 0
sample estimates:
           S         varS          tau 
2.000000e+00 2.562000e+03 5.291005e-03 
